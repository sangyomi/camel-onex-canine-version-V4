...
void MainWindow::GraphInitialize()
{
    ...
    ui->PLOT_CUSTOM_5->graph(0)->setName("Acc base x");
    ui->PLOT_CUSTOM_5->graph(1)->setName("Acc base y");
    ...
    ui->PLOT_CUSTOM_6->graph(0)->setName("Pos base x");
    ui->PLOT_CUSTOM_6->graph(1)->setName("Pos base y");
...
//        ui->PLOT_VEL_BASE_Z->graph(1)->addData(sharedMemory->localTime, sharedMemory->motorDesiredVelocity[2]);
        ...
        ui->PLOT_CUSTOM_5->graph(0)->addData(sharedMemory->localTime, sharedMemory->baseAcceleration[0]);
        ui->PLOT_CUSTOM_5->graph(1)->addData(sharedMemory->localTime, sharedMemory->baseAcceleration[1]);
        ui->PLOT_CUSTOM_5->graph(2)->addData(sharedMemory->localTime, sharedMemory->baseAcceleration[2]);


        ui->PLOT_CUSTOM_6->graph(0)->addData(sharedMemory->localTime, sharedMemory->testBasePos[0]);
        ui->PLOT_CUSTOM_6->graph(1)->addData(sharedMemory->localTime, sharedMemory->testBasePos[1]);
        ui->PLOT_CUSTOM_6->graph(2)->addData(sharedMemory->localTime, sharedMemory->testBasePos[2]);
...
void MainWindow::on_BT_TROT_clicked()
{
...
void MainWindow::on_BT_CUSTOM_GAIT1_clicked()
{
    ui->LE_STAND->setStyleSheet("background-color:pink");
    ui->LE_TROT->setStyleSheet("background-color:pink");
    ui->LE_CUSTOM_GAIT1->setStyleSheet("background-color:lightblue");
    ui->LE_CUSTOM_GAIT2->setStyleSheet("background-color:pink");
    sharedCommand->userCommand = CHANGE_GAIT_CUSTOM1;
    sharedMemory->newCommand = true;
}

void MainWindow::on_BT_CUSTOM_GAIT2_clicked()
{
    ui->LE_STAND->setStyleSheet("background-color:pink");
    ui->LE_TROT->setStyleSheet("background-color:pink");
    ui->LE_CUSTOM_GAIT1->setStyleSheet("background-color:pink");
    ui->LE_CUSTOM_GAIT2->setStyleSheet("background-color:lightblue");
    sharedCommand->userCommand = CHANGE_GAIT_CUSTOM2;
    sharedMemory->newCommand = true;
}
