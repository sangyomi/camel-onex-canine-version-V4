...
#ifndef Q_QCUSTOMPLOT_HPP
#define Q_QCUSTOMPLOT_HPP
...
public:
  ...
  */
    ...
    setMinimumSize and \ref setMaximumSize apply. The outer rect (\ref outerRect) include the
